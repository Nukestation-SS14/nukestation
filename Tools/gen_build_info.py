...
FORK_ID = "nukestation"
BUILD_URL = f"https://cdn.networkgamez.com/{{FORK_ID}}/builds/{{FORK_VERSION}}/{FILE}"
MANIFEST_URL = f"https://cdn.networkgamez.com/version/{{FORK_VERSION}}/manifest"
MANIFEST_DOWNLOAD_URL = f"https://cdn.networkgamez.com/version/{{FORK_VERSION}}/download"
